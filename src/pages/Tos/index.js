    ...
    <div className="App">
      ...
      <main>
        <div className="section dark">
          <div>
            <h1>Termos de Serviço do Bot Discord "Luarzito"</h1>
            <p>
            ...
            <ol>
              ...
              <li>
                ...
                atenda a todos os requisitos ou expectativas. O desenvolvedor do
                bot não se responsabiliza por qualquer perda ou dano decorrente
                do uso do bot.
              </li>
              <li>
              ...
              <li>
                O desenvolvedor do bot não se responsabiliza pelo mau uso do bot
                e não é responsável por quaisquer penalidades ou sanções
                aplicadas pelos administradores do servidor.
              </li>
              <li>
                Qualquer informação coletada pelo bot é regida pela Política de
                Privacidade do Bot Discord "Luarzito".
              </li>
              <li>
                Se você tiver alguma dúvida ou preocupação sobre o uso do bot,
                entre em contato com o desenvolvedor através do site oficial, da
                tag Discord ou do servidor de suporte do "Luarzito".
              </li>
            </ol>
            <p>
